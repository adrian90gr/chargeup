...
import CocheCargando from "../../public/images/coche_cargando.webp";
import Carretera from "../../public/images/carretera_naturaleza.webp";
...
export const CarruselComponent = () => {
  ...
  const slides = [
    ...
    { src: {CocheCargando}, alt: "Coche Cargando" },
    {
      src: {Carretera},
      alt: "Coche Cargando",
    },
